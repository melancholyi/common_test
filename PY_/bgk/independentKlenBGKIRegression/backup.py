...
kLen = torch.ones(2601, dtype=torch.float32, requires_grad=True)
kScalar = torch.ones(2601, dtype=torch.float32, requires_grad=True)
...
fig, axs = plt.subplots(1, 3, figsize=(15, 6))  # 1 row, 2 columnsimage
