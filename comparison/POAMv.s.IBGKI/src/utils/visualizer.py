...
class Visualizer:
    ...
    def plot_lengthscales(self, model, evaluator, min_lengthscale, max_lengthscale):
        ...
        print(f'YCY-DEBUG Lengthscales.shape: {lenscale.shape}')
        self.plot_image(
            index=0,
            matrix=lenscale,
            title="Lengthscales",
    ...
    def plot_lengthscales_ibgki(self, model, min_lengthscale, max_lengthscale):
        self.axes[0].clear()
        self.axes[0].axis("off")
        self.caxes[0].clear()
        lenscale = model.get_bgki_lengthscales()
        print(f'YCY-DEBUG Lengthscales.shape: {lenscale.shape}')
        self.plot_image(
            index=0,
            matrix=lenscale,
